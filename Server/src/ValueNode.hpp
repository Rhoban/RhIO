...
public:
   ...
   * does not exist
   */
  void setBool(const std::string& name, bool val, bool noCallblack = false,
               std::chrono::steady_clock::time_point timestamp = std::chrono::steady_clock::now());
  void setInt(const std::string& name, int64_t val, bool noCallblack = false,
              std::chrono::steady_clock::time_point timestamp = std::chrono::steady_clock::now());
  void setFloat(const std::string& name, double val, bool noCallblack = false,
                std::chrono::steady_clock::time_point timestamp = std::chrono::steady_clock::now());
  void setStr(const std::string& name, const std::string& val, bool noCallblack = false,
              std::chrono::steady_clock::time_point timestamp = std::chrono::steady_clock::now());
   ...
   */
  void setCallbackBool(const std::string& name, std::function<void(bool)> func);
  void setCallbackInt(const std::string& name, std::function<void(int64_t)> func);
  void setCallbackFloat(const std::string& name, std::function<void(double)> func);
  void setCallbackStr(const std::string& name, std::function<void(std::string)> func);
