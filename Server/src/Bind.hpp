...
public:
   ...
   */
  std::unique_ptr<ValueBuilderBool> bindNew(const std::string& name, bool& var, Policy policy = PushAndPull);
  std::unique_ptr<ValueBuilderInt> bindNew(const std::string& name, int& var, Policy policy = PushAndPull);
  std::unique_ptr<ValueBuilderInt> bindNew(const std::string& name, long& var, Policy policy = PushAndPull);
  std::unique_ptr<ValueBuilderFloat> bindNew(const std::string& name, float& var, Policy policy = PushAndPull);
  std::unique_ptr<ValueBuilderFloat> bindNew(const std::string& name, double& var, Policy policy = PushAndPull);
  std::unique_ptr<ValueBuilderStr> bindNew(const std::string& name, std::string& var, Policy policy = PushAndPull);
   ...
   * std::logic_error
   */
  void bind(const std::string& name, bool& var, Policy policy = PushAndPull);
  void bind(const std::string& name, int& var, Policy policy = PushAndPull);
  void bind(const std::string& name, long& var, Policy policy = PushAndPull);
  void bind(const std::string& name, float& var, Policy policy = PushAndPull);
  void bind(const std::string& name, double& var, Policy policy = PushAndPull);
  void bind(const std::string& name, std::string& var, Policy policy = PushAndPull);
  ...
  void bindFunc(const std::string& name, const std::string& comment, Ret (T::*func)(Args...), T& self,
   ...
   */
  void newStream(const std::string& name, const std::string& comment);
