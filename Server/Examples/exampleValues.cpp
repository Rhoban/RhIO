...
int main()
{
  ...
  // not thread safe
  std::cout << "paramInt name: " << RhIO::Root.getValueInt("path/paramInt").name << std::endl;
  std::cout << "paramInt value: " << RhIO::Root.getValueInt("path/paramInt").value << std::endl;
  std::cout << "paramInt is persisted: " << RhIO::Root.getValueInt("path/paramInt").persisted << std::endl;
  std::cout << "paramInt has minimum: " << RhIO::Root.getValueInt("path/paramInt").hasMin << std::endl;
  std::cout << "paramInt minimum value: " << RhIO::Root.getValueInt("path/paramInt").min << std::endl;
  std::cout << "paramInt has maximum: " << RhIO::Root.getValueInt("path/paramInt").hasMax << std::endl;
  std::cout << "paramInt minimum value: " << RhIO::Root.getValueInt("path/paramInt").max << std::endl;
  ...
  RhIO::Root.setInt("path/paramInt", 42, false, std::chrono::steady_clock::now());
  ...
  RhIO::Root.setCallbackInt("path/paramInt", [](int val) { std::cout << "Callback on set: " << val << std::endl; });
