...
public:
    ...
    , _attrInt()
  {
    ...
    _binder.node().newStr("paramStr")->comment("description paramStr");
    ...
    _binder.bindNew("paramDouble", _attrDouble)->comment("description paramDouble");
    ...
    _binder.bindNew("dir/paramInt", _attrInt, RhIO::Bind::PushOnly)->comment("description paramInt");
    ...
    _binder.bindFunc("command1", "description command1", &Object::member1, *this);
    ...
    _binder.bindFunc("command2", "description command2", &Object::member2, *this, { "3.14", "true" });
  }
...
int main()
{
  ...
  std::cout << "paramDouble: " << RhIO::Root.getFloat("path/in/tree/paramDouble") << std::endl;
