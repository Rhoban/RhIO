...
public:
   ...
   */
  std::vector<std::string> listChildren(const std::string& name);

  /**
   * Return the list of values name registered
   * into given absolute node name for each types
   */
  std::vector<std::string> listValuesBool(const std::string& name);
  std::vector<std::string> listValuesInt(const std::string& name);
  std::vector<std::string> listValuesFloat(const std::string& name);
  std::vector<std::string> listValuesStr(const std::string& name);

  /**
   * Return the list of available commands on
   * a given absolute node name
   */
  std::vector<std::string> listCommands(const std::string& name);
   ...
   * call result
   */
  std::string call(const std::string& name, const std::vector<std::string>& arguments);
   ...
   * a given absolute node name
   */
  std::vector<std::string> listStreams(const std::string& name);
   ...
   * a given absolute node name
   */
  std::vector<std::string> listFrames(const std::string& name);
   ...
   */
  void save(const std::string& name, const std::string& serverPath);
  void load(const std::string& name, const std::string& serverPath);
...
private:
   ...
   */
  DataBuffer waitReply(zmq::message_t& reply, MsgType expectedType);
   ...
   */
  std::vector<std::string> listNames(MsgType msgType, const std::string& name);
};
