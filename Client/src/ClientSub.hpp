...
public:
   ...
   */
  typedef std::function<void(const std::string& name, int64_t timestamp, bool val)> StreamBoolHandler;
   ...
   */
  void setHandlerBool(StreamBoolHandler handler = StreamBoolHandler());
  void setHandlerInt(StreamIntHandler handler = StreamIntHandler());
  void setHandlerFloat(StreamFloatHandler handler = StreamFloatHandler());
